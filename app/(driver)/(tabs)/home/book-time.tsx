import PublishSucessModal from "@/src/components/driver/modal/PublishSuccessModal";
...
export default function BookTimeScreen() {
  ...
  const handleNextButton = () => {
    ...
    // Show toast notification for driver
    Toast.show({
      type: "success",
      position: "top",
      text1: "Ride Published",
      text2: "Your ride has been published successfully",
      visibilityTime: 3000,
      autoHide: true,
      topOffset: 30,
    });

    // Show toast notification for matching passengers
    // Toast.show({
    //   type: "info",
    //   position: "bottom",
    //   text1: "New Ride Available",
    //   text2: "A driver has published a ride matching your address",
    //   visibilityTime: 3000,
    //   autoHide: true,
    //   bottomOffset: 30,
    // });
    ...
    setTimeout(() => {
      setShowModal(false);
      router.replace("/(driver)/(tabs)/trip");
    }, 1000);
  };
