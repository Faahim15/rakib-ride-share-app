  ...
  return (
    <View className="flex-1 pt-[3%] px-[6%] bg-white">
      ...
      {/* <View className="justify-center items-center">
        <Text className="text-[#111] text-lg mb-[3%] font-poppinsSemiBold py-[3%] ">
          My Trip
        </Text>
      </View> */}
      {/* Main Content */}
      <View className="flex-1 ">
        ...
        <LocationPicker
          ...
          dropoffPlaceholder="Dropping off"
        />
        ...
        {(pickupMarker || dropoffMarker) && (
          <View className="mt-6 p-4 bg-gray-50 rounded-xl">
            <Text className="text-base font-poppinsSemiBold mb-3 text-gray-800">
              {t("passenger.tabs.trip.selectedLocation")}:
            </Text>
            ...
            {pickupMarker && (
              <View className="mb-3">
                ...
                <Text className="text-sm font-poppins text-gray-500 ml-5">
                  Lat: {pickupMarker.latitude.toFixed(6)}, Lng:{" "}
            ...
            {dropoffMarker && (
              <View>
                ...
                <Text className="text-sm font-poppins text-gray-500 ml-5">
                  Lat: {dropoffMarker.latitude.toFixed(6)}, Lng:{" "}
        ...
        <View className="flex-1 pb-[20%] justify-end space-y-3">
          <TouchableOpacity
            className="bg-brandColor rounded-xl py-[5%] items-center shadow-md"
            onPress={handleNext}
